...
issues, and other contributions that are not aligned to
this Code of Conduct, and will communicate reasons for
...
* **Email:** Mavis@local
* **GitHub:** https://github.com/yuri-schmaltz/xreader/issues
  (mark with the `code-of-conduct` label)

All complaints will be reviewed and investigated promptly
and fairly.  All community leaders are obligated to respect
